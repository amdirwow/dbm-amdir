...
local enrageTimer			= mod:NewBerserkTimer(mod:IsHeroic() and 360 or 480)
...
local warnRuneofBlood		= mod:NewTargetNoFilterAnnounce(72410, 3)
...
function mod:OnCombatStart(delay)
	...
	if self.Options.Timer72410cd ~= nil then
		self.Options.Timer72410cd = true
	end
	if self.Options.Timer72410next ~= nil then
		self.Options.Timer72410next = true
	end
...
function mod:SPELL_AURA_REMOVED(args)
	if args:IsSpellID(72385, 72441, 72442, 72443) and args:IsDestTypePlayer() and self.Options.BoilingBloodIcons then
