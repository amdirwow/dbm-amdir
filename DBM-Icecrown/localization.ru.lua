...
L:SetMiscLocalization({
	...
	PullAlliance		= "Усі воїни Орди, всі дохлі пси Альянсу – всі поповнять армію Короля-лича. Навіть зараз валькири воскресають ваших покійників, щоб ті стали частиною Скари!",
	PullHorde			= "Кор'крон, висуватися! Герої, будьте напоготові. Скара щойно..."
})
