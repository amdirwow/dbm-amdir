...
L:SetMiscLocalization({
	...
	Pull1				= "Біжіть, біжіть! Я люблю гарячу кров!",
	Pull2				= "Подивимося які ви на смак!"
})
...
L:SetMiscLocalization({
	Pull				= "Смерть чужинцям!",
	Adds				= "закликає скелетів-воїнів!",
	AddsTwo				= "піднімає нових скелетів!"
})
...
L:SetMiscLocalization({
	yell1			= "Лоскутик хоче пограти!",
	yell2			= "Кел'Тузад оголосив Лоскутика втіленням війни!",
...
L:SetMiscLocalization({
	Yell	= "Сталагг скрушити вас!",
	Emote	= "%s перезавантажується!",
	Emote2	= "Котушка Тесла перезавантажується!",
	Boss1	= "Фойген",
	Boss2	= "Сталагг",
	Charge1 = "негативну",
	Charge2 = "позитивну"
...
L:SetMiscLocalization({
	Yell1 = "Покажіть мені, що здатні!",
	Yell2 = "Навчання закінчено! Покажіть мені, що ви засвоїли!",
	Yell3 = "Згадайте, чого я вас навчав!",
	Yell4 = "Вище ноги! Чи в тебе із цим проблеми?"
})
...
L:SetMiscLocalization({
	...
	Knight			= "Лицаря",
	Rider			= "Вершника",
	GothikDoorEmote	= "Центральні ворота відчиняються!",
	GothikPhase2Yell= "Я чекав надто довго. Тепер ви постане перед обличчям Жнеца душ."
})
...
L:SetMiscLocalization({
	EmoteBreath			= "%s глибоко вдихає.",
	AirPhase			= "Сапфірон злітає у повітря!",
	LandingPhase		= "Сапфірон поновлює свою атаку!"
})
...
--	YellMC2		= "Тебе не уйти!",
	Yell1Phase2	= "Моліть про пощаду!", -- 12995
	Yell2Phase2	= "Кричіть! Кричіть щосили!", -- 12996
	Yell3Phase2	= "Ви вже мертві!", -- 12997
	YellPhase3	= "Пане, мені потрібна допомога!", -- 12998
	YellGuardians	= "Добре. Воїни крижаних пусток, встаньте! Наказую вам боротися, вбивати і вмирати в ім'я свого повелителя! Не щадити нікого!", -- 12994
