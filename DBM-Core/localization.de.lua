...
L.MOD_AVAILABLE				= "Das Mod \"%s\" ist für diese Zone/Boss verfügbar. Du kannst es von Curse/WoWI oder amdir.in.ua herunterladen."
...
L.UPDATEREMINDER_MAJORPATCH		= "WARNUNG: Da dein "..L.DEADLY_BOSS_MODS.." veraltet und deshalb leider für diesen Major Patch des Spiels nicht mehr geeignet ist, hat es sich bis zu einer Aktualisierung deaktiviert. Alter und inkompatibler Code kann zu einem schlechten Spielerlebnis bei dir oder deinen Schlachtzugsmitgliedern führen. Bitte lade dir baldmöglichst eine neue Version von amdir.in.ua oder Curse herunter."
