...
L.DEADLY_BOSS_MODS						= "DBM-Amdir" -- NO TRANSLATE
L.DBM									= "DBM-Amdir" -- NO TRANSLATE
...
L.UPDATEREMINDER_URL					= "https://github.com/amdirwow/dbm-amdir/releases"
