...
--		DBM:AddMsg("Submerge Visual unhidden from event log. Report this to Amdir on Discord")
...
--		DBM:AddMsg("Submerge is being synced by something. Report this to Amdir on Discord with a Transcriptor log")
--[[	self.vb.submerged = true
		self.vb.guardianKill = 0
		self.vb.ambusherKill = 0
		timerSubmerge:Cancel()
